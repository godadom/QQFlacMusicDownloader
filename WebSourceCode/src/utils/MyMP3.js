...
function encodev2(e) {
  ...
  if (a["sgaxo"]("uoEzq", "vfZfe"))
    return _0x22c560[o(481, n(889))](
      _0x201ecd[o(432, n(2389))](
        a[n(1095)](_0x1c798f, _0x5bc49a[o(437, "UNW!")])
      )
    );
...
const Hs = function (e) {
  ...
  Ns = function () {
    ...
    if (s[t.sxyvs](s["FXuRG"](Qs, window), "object")) o = s["REMrC"];
      ...
      s["uOXrD"](Qs(window["__VUE__"]), "boolean") &&
      s["ynHhf"](window["__VUE__"], !0)
    ) {
...
function Vs(e) {
    ...
    for (var y = m["UvJUa"]["split"]("|"), g = 0; ; ) {
      switch (y[g++]) {
        ...
        case "3":
          h +=
            m["TjpAy"](
              m.GVZtk(As["charAt"](i), As["charAt"](l)),
              As["charAt"](c)
            ) + As["charAt"](u);
          continue;
        case "4":
  ...
  return m["TjpAy"](
    v ? h["slice"](0, m["oYAvf"](v, 3)) : h,
    m["lPeqS"]["slice"](m["OcODS"](v, 3))
  );
}
